...
def run_new_estimators_unit_tests():
    print("==========================================================================")
    print("RUNNING DIRECTION 1 & 5 NEW ESTIMATORS UNIT TESTS")
    print("==========================================================================")
    ...
    print("--> PASS: Sequential pilot strictly enforces query budget m!")

    # TEST 2: Sample Reuse Cross-Fitting Query Count
    print("\n--- Test 2: Sample Reuse Cross-Fitting Query Count (oracle.query_count == m) ---")
    oracle.reset_query_count()
    est_cross = Hutch_pplus_CrossFitting(
        oracle, m, d, k=50, rng=np.random.default_rng(42)
    )
    print(f"Sample Reuse Cross-Fitting Estimate: {est_cross:.6f}")
    assert oracle.query_count == m, f"Cross-fitting query mismatch: used {oracle.query_count}, expected {m}"
    print("--> PASS: Sample reuse cross-fitting strictly enforces query budget m!")

    print("\n==========================================================================")
    print("ALL DIRECTION 1 & 5 NEW ESTIMATOR UNIT TESTS PASSED SUCCESSFULLY!")
    print("==========================================================================")
